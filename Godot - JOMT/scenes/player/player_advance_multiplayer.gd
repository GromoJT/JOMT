...
#@onready var pouse_menu: ColorRect = $Game_UI/ColorRect
...
func _physics_process(delta):
	...
	#print(input_dir.x)
	$Nek/Head/Eyes/MainCamera3D/Face.position = main_camera_3d.position
	$Nek/Head/Eyes/MainCamera3D/Face.rotation = main_camera_3d.rotation
